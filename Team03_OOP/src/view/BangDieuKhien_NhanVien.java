...
public class BangDieuKhien_NhanVien extends JPanel {

    private QuanLi_NhanVien quanLyNhanVien;
    ...
    public BangDieuKhien_NhanVien(QuanLi_NhanVien quanLyNhanVien) {
    ...
    private NhanVien taoNhanVienTuForm() {
        try {
            ...
            if (cv.equals("Ban Hang")) return new NhanVien_BanHang(cv, id, ten, gt, ns, sdt, dc, nghi, ca);
            if (cv.equals("Thu Ngan")) return new NhanVien_ThuNgan(cv, id, ten, gt, ns, sdt, dc, nghi, ca);
            return new NhanVien_QuanLiKho(cv, id, ten, gt, ns, sdt, dc, nghi, ca);
        } catch (Exception e) {
