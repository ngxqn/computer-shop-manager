...
public class MainFrame extends JFrame {
    ...
    private QuanLi_SanPham qlsp = new QuanLi_SanPham(); //
    private QuanLi_Kho qlk = new QuanLi_Kho(qlsp);     //
    private QuanLi_NhanVien qlnv = new QuanLi_NhanVien(); //
    private QuanLi_KhachHang qlkh = new QuanLi_KhachHang(); //

    // 2. Khai báo các Panel giao diện cho từng tab
    private BangDieuKhien_SanPham sanPhamPanel;
    private BangDieuKhien_GiaoDich giaoDichPanel;
    private BangDieuKhien_HoaDon hoaDonPanel;
    private BangDieuKhien_NhanVien nhanVienPanel; //
    private BangDieuKhien_KhachHang khachHangPanel; //
    ...
    public MainFrame(String title) {
        ...
        giaoDichPanel = new BangDieuKhien_GiaoDich(qlk, qlsp);

        // Tab Hóa Đơn: Chuyên trách lập hóa đơn bán hàng và hiển thị lịch sử
        hoaDonPanel = new BangDieuKhien_HoaDon(qlsp);

        // Tab Sản Phẩm: Quản lý danh mục sản phẩm tại cửa hàng
        sanPhamPanel = new BangDieuKhien_SanPham(qlsp);

        // Tab Nhân Viên: Quản lý thông tin và lương nhân sự
        nhanVienPanel = new BangDieuKhien_NhanVien(qlnv);

        // Tab Khách Hàng: Quản lý thông tin khách hàng thân thiết
        khachHangPanel = new BangDieuKhien_KhachHang(qlkh);
